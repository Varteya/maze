...
# Project:  Maze.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Maze.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtOpenGL -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I.
LINK          = g++
LFLAGS        = -m64
...
Makefile: Maze.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -spec linux-g++-64 CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile Maze.pro
...
dist: 
	@test -d .tmp/Maze1.0.0 || mkdir -p .tmp/Maze1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Maze1.0.0/ && $(COPY_FILE) --parents textures.qrc .tmp/Maze1.0.0/ && $(COPY_FILE) --parents field.h glwidget.h Player.h .tmp/Maze1.0.0/ && $(COPY_FILE) --parents main.cpp glwidget.cpp field.cpp player.cpp .tmp/Maze1.0.0/ && (cd `dirname .tmp/Maze1.0.0` && $(TAR) Maze1.0.0.tar Maze1.0.0 && $(COMPRESS) Maze1.0.0.tar) && $(MOVE) `dirname .tmp/Maze1.0.0`/Maze1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Maze1.0.0
...
moc_glwidget.cpp: /usr/include/qt5/QtOpenGL/QGLWidget \
		...
		/usr/include/qt5/QtOpenGL/QGLShader \
...
glwidget.o: glwidget.cpp /usr/include/qt5/QtOpenGL/QtOpenGL \
		...
		/usr/include/qt5/QtOpenGL/QGLFunctions \
		glwidget.h \
		/usr/include/qt5/QtOpenGL/QGLWidget \
		/usr/include/qt5/QtOpenGL/QGLShader \
		/usr/include/qt5/QtCore/QTimer \
